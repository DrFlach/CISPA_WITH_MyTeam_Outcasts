...
from src.lmms.models.utils import PreTrainedModel
...
class Olmo2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        query_states = self.q_norm(self.q_proj(hidden_states, modality_masks))
        key_states = self.k_norm(self.k_proj(hidden_states, modality_masks))
